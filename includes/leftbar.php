    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <!-- Staff -->
                <li class="has-children">
                    <a href="#"><i class="fa fa-black-tie me-1"></i>  <span> Staff</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="add-staff.php"><i class="fa fa-bars"></i> <span>Add Staff</span></a></li>
                        <li><a href="staff-records.php"><i class="fa fa fa-server"></i> <span>Manage Staff</span></a></li>
                        <li><a href="assign-subjects.php"><i class="fa fa fa-server"></i> <span>Assign Subjects</span></a></li>
                    </ul>
                </li>
                ...
                <!-- Attendance -->
                <li class="has-children">
                    <a href="#"><i class="fa fa-calendar-check-o"></i> <span>Attendance</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
