...
<title>HOD Dashboard | SRMS</title>
...
.quick-actions .card { color:#fff; border-radius:12px; padding:25px; text-align:center; transition:all 0.3s ease; font-weight:600; cursor:pointer; box-shadow:0 3px 10px rgba(0,0,0,0.1); text-decoration:none; display:flex; flex-direction:column; align-items:center; justify-content:center; }
...
<div class="content">
    ...
    <div class="quick-actions">
        <a href="manage-staff.php" class="card card-blue"><i class="fa fa-users"></i><div>Manage Staff</div></a>
        <a href="assign-subjects-to-staff.php" class="card card-green"><i class="fa fa-book"></i><div>Assign Subjects</div></a>
        <a href="view-students.php" class="card card-orange"><i class="fa fa-users"></i><div>View Students</div></a>
        <a href="notice.php" class="card card-pink"><i class="fa fa-bell"></i><div>Notice</div></a>
        <a href="profile-settings.php" class="card card-gray"><i class="fa fa-cog"></i><div>Profile Settings</div></a>
    </div>

    <!-- Notices Section -->
    <h4 class="mb-3 mt-5">📢 Notices from Admin</h4>
